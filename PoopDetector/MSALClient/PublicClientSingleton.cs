...
namespace SignInMaui.MSALClient
{
    ...
    public class PublicClientSingleton
    {
        ...
        private PublicClientSingleton()
        {
            ...
            using var stream = assembly.GetManifestResourceStream($"{Assembly.GetCallingAssembly().GetName().Name}.appsettings.json");
        ...
        {
            return this.DownstreamApiHelper.DownstreamApiConfig.FullNameScopesArray;
        }
    }
}
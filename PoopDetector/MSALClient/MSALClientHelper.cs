...
namespace SignInMaui.MSALClient
{
    ...
    public class MSALClientHelper
    {
        ...
        public string Token
        {
            get
            {
                // it seems the tokens are accessed differently, depending on whether the app was logged in directly, or from cache.
                if (AuthResult == null)
                ...
                if (AuthResult.IdToken != null) 
                    ...
                    throw new Exception("Should be logged in, but Token nowhere to be found!");
            }
        }
        ...
        /// </summary>
        public MSALClientHelper(AzureAdB2CConfig azureAdConfig)
        {
            AzureAdB2CConfig = azureAdConfig;
        ...
        private void InitializePublicClientApplicationBuilder()
        {
            this.PublicClientApplicationBuilder = PublicClientApplicationBuilder.Create(AzureAdB2CConfig.ClientId)
                .WithExperimentalFeatures() // this is for upcoming logger
                                            ...
                                            //.WithB2CAuthority(string.Format(AzureAdB2CConfig.Authority, AzureAdB2CConfig.TenantId))
...
#endif
                .Build();
            var accs = await AttachTokenCache();
        ...
        {
            // ERROR: For whatever reason my app registration with custom Scopes stopped being cached. Had to make a new one withouth those scopes and it started working magically.
            Exception<NullReferenceException>.ThrowOn(() => this.PublicClientApplication == null, PCANotInitializedExceptionMessage);

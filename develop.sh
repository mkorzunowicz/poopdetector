__doc__='
This was my attempt to get this to build on Linux, but it looks like that does not work.

But it is possible to get the android emulator on linux to test a package.
...
attemp_dotnet_install(){
    # Dont bother with this on linux, you wont be able to build the app
